\input{5-smart-contract-security/sections/tables/reentrancy}
...
\input{5-smart-contract-security/sections/tables/unhandled-exceptions}
...
% \input{5-smart-contract-security/sections/tables/locked-ether}
...
\input{5-smart-contract-security/sections/tables/tod}
...
% \input{5-smart-contract-security/sections/tables/integer-overflow}

\input{5-smart-contract-security/sections/tables/summary}
