\begin{figure}[tb]
  ...
  \begin{subfigure}{.49\columnwidth}
    \centering
    \includegraphics[width=\textwidth]{./5-smart-contract-security/figures/balance-histogram.pdf}
    \caption{\scriptsize Ether held by contracts in our dataset\\with non-zero balance.}
    \label{fig:eth-held}
  \end{subfigure}
  \begin{subfigure}{.49\columnwidth}
    \centering
    \includegraphics[width=\textwidth]{./5-smart-contract-security/figures/cumulative-ether.pdf}
