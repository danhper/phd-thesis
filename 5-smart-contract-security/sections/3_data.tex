...
\begin{figure}[tb]
  \begin{subfigure}{0.48\columnwidth}
    \includegraphics[width=\textwidth]{./5-smart-contract-security/figures/overlap-analyzed.pdf}
    \caption{Overlapping contracts\\analyzed.}
    \label{fig:all-overlap}
  \end{subfigure}
  \begin{subfigure}{0.48\columnwidth}
    \includegraphics[width=\textwidth]{./5-smart-contract-security/figures/overlap-vulnerable.pdf}
