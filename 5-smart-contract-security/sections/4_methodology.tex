...
% \bottomrule\\
% \end{tabular}
% \caption{Soundness and completeness properties for the analyses in this paper.}
% \end{figure}
...
\input{5-smart-contract-security/sections/datalog}
