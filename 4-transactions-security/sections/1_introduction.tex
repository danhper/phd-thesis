...
% In Section~\ref{sec:background} we provide the necessary background on each of the blockchain platforms studied. In Section~\ref{sec:methodology} we describe the data collected from the three blockchains.
% In Section~\ref{sec:data-analysis} we conduct high-level analyses. 
% In Section~\ref{sec:case-studies} we present several investigative case studies that highlight how transactions are (mis)used in the three blockchains. 
% In Section~\ref{sec:related} we summarize related work and conclude in Section~\ref{sec:conclusion}.
